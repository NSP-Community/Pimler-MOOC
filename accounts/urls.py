...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(template_name="accounts/login.html", redirect_authenticated_user=True), name='user_login'  ), # template_name="accounts/login.html",
